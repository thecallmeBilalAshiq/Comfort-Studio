...
export function FadeInLeft({ children, className = '', delay = 0 }: Props) {
  ...
  return (
    <div ref={ref} className={`animate-fade-in-left ${className}`}>
      {children}
    </div>
  );
}
...
export function FadeInRight({ children, className = '', delay = 0 }: Props) {
  ...
  return (
    <div ref={ref} className={`animate-fade-in-right ${className}`}>
      {children}
    </div>
  );
}
...
export function ScaleIn({ children, className = '', delay = 0 }: Props) {
  ...
  return (
    <div ref={ref} className={`animate-scale-in ${className}`}>
      {children}
    </div>
  );
}
