...
export default function OrdersPage() {
  ...
  const renderOrderCard = (order: any, isTrackedView = false) => {
    const isExpanded = expandedOrder === order.id || isTrackedView;
    return (
                        ...
                        <button
                          ...
                          onClick={async () => {
                            ...
                            try {
                              ...
                              if (isTrackedView) {
                                setTrackedOrder((prev: any) => ({ ...prev, paymentScreenshot: res.paymentScreenshot }));
                              } else {
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        {trackedOrder && (
          <div className="space-y-4">
            <h2 className="font-semibold text-lg text-gray-700">Tracking Results:</h2>
      ...
      {trackedOrder && (
        <div className="mb-8 space-y-3">
          <div className="flex justify-between items-center">
            <h3 className="font-semibold text-gray-700">Tracked Order:</h3>
            <button onClick={() => setTrackedOrder(null)} className="text-xs text-gray-400 hover:text-accent">Clear search</button>
          </div>
          {renderOrderCard(trackedOrder, true)}
        </div>
      )}
